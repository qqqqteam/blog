...
_('nmode').onclick = function() {
  ...
  setTimeout(function(){
    _('nmode').innerHTML = 'sc@m mod ' + (nightmode ? 'off' : 'on');
  }, 500);
...
function nightRun() {
	...
	document.documentElement.style.setProperty(('--background'), 'radial-gradient(ellipse  at ' + ((rect.left + rect.right) / 2) + 'px ' + (rect.top + 20) + 'px, rgb(240,240,240) 0%, rgb(240,240,240) ' + t + '%, rgb(20,20,20) ' + b + '%, rgb(20,20,20) 100%)');
